                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Daftar Purchase Payment
                                            </span>
                                        </div>
                                         <div class="actions">
                                                ...
                                                <div class="col-md-8">
                                                 ...
                                                 <div class="col-md-4">
   <a href="<?php echo base_url(); ?>purchase_payment/add" class="btn btn-circle btn-success" id="search" type="button"> <i class="fa fa-plus"></i> Tambah Purchase Payment</a>
                                                 </div>
