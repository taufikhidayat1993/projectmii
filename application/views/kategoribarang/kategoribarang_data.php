<style>
 ...
 <div class="page-bar">
       ...
       <div class="row">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">List Kategori
                                            </span>
                                        </div>
                                         <div class="actions">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <input type="text" id="search_name_group" class="form-control" placeholder="Kategori Search">
                                                        <span class="input-group-btn">
                                                            <button class="btn blue" id="search" type="button">Search</button>
                                                             <a  href="<?php echo site_url('kategoribarang/tambah_kategoribarang'); ?>"  id="tambahkategoribarang"                                            class="btn sbold green">Add Kategori
		    ...
		    $(document).ready(function () {
             ...
             "defaultContent": ""
					...
					"ajax": {
						"url": "<?php echo base_url('kategoribarang/server_side'); ?>",
						"type": "POST",
						"data":function(data) {
		...
		$(document).on('click', '#tambahkategoribarang, #Editkategoribarang', function(e){
    e.preventDefault();

    $('.modal-dialog').removeClass('modal-sm');
    $('.modal-dialog').removeClass('modal-lg');
        if($(this).attr('id') == 'Editkategoribarang')
        {
    ...
    if($(this).attr('id') == 'tambahkategoribarang'){
    $('.modal-title').html('Tambah group Baru');
     $('.modal-footer').html("<button type='button'data-dismiss='modal' class='btn dark btn-outline'>Close</button><button type='button' class='btn green'  onClick='tambahkategoribarang()' >Simpan</button>");
        }
...
$(document).on('click', '#hapuskategoribarang', function(e){
        e.preventDefault();
