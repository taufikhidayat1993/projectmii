          ...
          <div id="info"></div>
                                                            <div class="row">
                                                               <div class="portlet-body form">
                                                                <form class="form-horizontal" id="form_edit_pelanggan" action="<?php echo site_url('kategoribarang/kategoribarang_edit_data/'.$kategoribarang->kategori_id.''); ?>" method="post">
                                                                     <div class="form-body">
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Nama Kategori</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" id="nama_kategori" name="nama_kategori" class="form-control" value="<?php echo $kategoribarang->nama_kategori; ?>" placeholder="Enter text">
                                                                </div>
                                                            </div>
