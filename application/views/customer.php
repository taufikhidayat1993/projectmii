...
<div class="content" id="page">
  ...
  <div class="container-fluid container-fixed-lg">
    <ul class="breadcrumb">
      ...
      <li><a href="#" class="active">Customer</a>
      </li>
    </ul>
    <!-- END BREADCRUMB -->
  </div>
        ...
        <div class="row">
            <div id="portlet-circular" class="panel panel-default">
              ...
              <div class="panel-body">
                  <div class="pull-left">
                      <div class="col-xs-12">
                          <button id="show-modal" onclick="showUser()" class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Add Customer </button>
                      </div>
                  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header clearfix text-left">
          ...
          <h5 id="title"><span class="semi-bold">Add Customer</span></h5>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group-attached">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group form-group-default">
                    <label>Photo</label>
                    <input type="file" class="form-control" id="u_email" style="text-decoration:none;">
                  </div>
                </div>
              </div>
              <div class="row">
