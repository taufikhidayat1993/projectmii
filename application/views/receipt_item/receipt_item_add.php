...
<div class="page-bar">
  <?php echo $this->breadcrumb->show() ?>                     
                ...
                <form class="form-horizontal" id="form_add_pelanggan" action="<?php echo site_url('receipt_item/receipt_item_simpan'); ?>" method="post">
					      <div class="row">
                                                     ...
                                                     <label class="col-md-3 control-label">Receive Date</label>
                                                          ...
                                                          <input type="text" id="tanggal_pi"  name="tanggal_pi" class="form-control input-sm  dp" value="<?php echo date('d/m/Y'); ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="input-group input-sm" name="form_no" id="form_no">
                                                                      <span  class="input-group-btn">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                  <div class="input-group">
                                                            <select  class='form-control input-sm select2 akun' name="vendor" id="vendor">
                                                                    	<option value="">Pilih Nama Vendor</option>
                                                             </select>
                                                             <input type="hidden" name="kode_po" id="kode_po">
                                                             <span  class="input-group-btn">
                                                                      <a  href="<?php echo site_url('receipt_item/list_po'); ?>" class="btn btn-primary btn-sm" id="cari_po">
                                                              View PO
                                                             </a>
                                                             </span>
                                                           </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Receive No</label>

                                                                <div class="col-md-6">
                                                                    
                                                              <input type="text"  name="no_pi" 
                                                            " class="form-control input-sm" id="no_pi" > 
                                                                </div>
                                                            </div>
                                                           </div>
                                                        </div>
			...
			<table class="table table-striped table-hover" id="TabelTransaksi">
				 ...
				 <div class='col-md-12'>
				   <div class='portlet light'>
									...
									<form action="<?php echo base_url();?>receipt_item/receipt_item_simpan" class="form-horizontal"  method="post" id="form_sample_1"  accept-charset="utf-8">
									<div class='form-body'>
									<div class="row">		
		<div class='col-md-6'>
      <!--
         <div class='form-group' id="uangmuka" style="display: none">
            <label class='col-md-3 control-label'>Uang Muka</label>
                <div class='col-md-9'>													
                  <input type='text'  id="uang_muka" name="uang_muka"  class='form-control input-sm'>
         </div>
     </div>
   -->
        <div class='form-group'>
                <label class='col-md-3 control-label'>A/P Account</label>
                      <div class='col-md-9'>
                      	<select class="form-control input-sm" name="kas_bayar">
     <?php
     ...
     ?>
        ...
        <div class='form-group'>
                <label class='col-md-3 control-label'>Keterangan</label>
                      <div class='col-md-9'>
                       <textarea class="form-control input-sm" name="keterangan"></textarea>
            </div>
        </div>
...
<span class="input-group-addon">
                  ...
                  <input type='text'  id="ppn" name="ppn"  class='form-control input-sm input-medium'>
                  <input type='hidden'  id="ppn2" name="ppn2"  class='form-control input-sm input-medium'>
                </div>
         </div>
         </div>
        <div class='form-group'>
                <label class='col-md-3 control-label'>Subtotal
                      ...
                      <div class='col-md-9'>
      <input type='hidden'  id="TotalSubtotalhidden" name="TotalSubtotalhidden"  class='form-control input-sm'>
                  <span id="TotalSubtotal" class="form-control input-sm-static"></span>
            </div>
        </div>
         <div class='form-group'>
                <label class='col-md-3 control-label'>Total Payment
                      ...
                      <div class='col-md-9'>
       <input type='hidden'  id="TotalBayarHidden" name="pr_no"  class='form-control input-sm'>
                  <span id="TotalBayar" class="form-control input-sm-static"></span>
         </div>
            </div>
        </div>
											</div>
...
function BarisBaru()
{
	...
	var Baris = "<tr>";
		...
		Baris += "<td>";
			Baris += " <input type='text' class='form-control input-sm' name='uji' id='kode_barang' placeholder='Ketik Kode / Nama Barang'></div>";
      ...
      Baris += "<td><input type='text' class='form-control input-sm input-xsmall' id='jumlah_request' name='jumlah_request[]' onkeypress='return check_int(event)' ></td>";
	  Baris += "<td><input type='text' class='form-control input-sm input-xsmall' id='jumlah_order' name='jumlah_order[]' onkeypress='return check_int(event)' ></td>";
				Baris += "<td><input type='text' class='form-control input-sm input-xsmall'  name='satuan[]'><span></span></td>";
	  Baris += "<td><input type='text' class='form-control input-sm input-xsmall' id='harga' name='harga[]' onkeypress='return check_int(event)' ></td>";
				Baris += "<td><span></span><input type='hidden' class='form-control input-sm input-xsmall' id='subtotal' name='subtotal[]' onkeypress='return check_int(event)' ></td>";
...
var ammount = $('#daftarpo tbody tr:eq('+$(this).parent().parent().parent().parent().index()+') td:nth-child(5)').html();
  $('#data_request').load("<?php echo base_url();?>/receipt_item/get_po/"+kodenya);
...
function SimpanTransaksi()
{
    ...
    $.ajax({
		url: "<?php echo site_url('receipt_item/receipt_item_simpan'); ?>",
		type: "POST",
		cache: false,
		data: FormData,
		dataType:'json',
