...
<tr><td><?php echo $no; ?></td>
	...
	<td><input type="text" class="form-control input-xsmall" id="jumlah_order" value="<?php echo $row->qty; ?>"  name="jumlah_order[]" onkeypress="return check_int(event)"></td><td><input type="hidden" name="satuan[]" value="<?php echo $row->satuan; ?>"><span><?php echo $row->satuan; ?></span></td><td><input type="text" class="form-control input-xsmall" id="harga" name="harga[]" onkeypress="return check_int(event)"></td>
	<td><input type="hidden" class="form-control input-xsmall" id="subtotal" name="subtotal[]" onkeypress="return check_int(event)"><span></span></td>
